...
public class Level_08_LifeCycle_ActionChanging extends AbstractTest {
	...
	public void TC_03_ActionChanging() throws Exception {
		//Home Page >> Custormer Infor
		headerMyAccountPO = homePage.openHeaderMyAccountPage();
		// Header My Account >> Footer (SiteMAp)
		siteMapPage = homePage.openSiteMapPage();
		// Sitemap >> Shipping and returns
		shippingAndReturnPage = siteMapPage.openShippingAndReturn();
		// Shipping >> Footer
		footerMyAccountPO = shippingAndReturnPage.openFooterMyAccountPage();
		// Footer >> Search
		searchPage = footerMyAccountPO.openSearchPage();
